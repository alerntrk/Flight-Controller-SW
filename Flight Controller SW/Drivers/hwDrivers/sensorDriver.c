...
sensor_status_e sensor_test_device( uint8_t chipAdd )
{
    ...
    status = HAL_I2C_IsDeviceReady( &hi2c3, chipAdd, I2C_NUMBER_OF_TRIALS, I2C_TIMEOUT );
...
uint16_t sensor_read_register16(uint8_t chipAdd, uint8_t regAdd)
{
    ...
    status = HAL_I2C_Mem_Read( &hi2c3, chipAdd, regAdd, I2C_REG_ADD_SIZE_1_BYTE, data, I2C_DATA_SIZE_2_BYTES, I2C_TIMEOUT );
...
sensor_status_e sensor_write_register16(uint8_t chipAdd, uint8_t regAdd, uint16_t value)
{
    ...
    status = HAL_I2C_Mem_Write( &hi2c3, chipAdd, regAdd, I2C_REG_ADD_SIZE_1_BYTE, data, I2C_DATA_SIZE_2_BYTES, I2C_TIMEOUT );
...
sensor_status_e sensor_write_bytes(uint8_t chipAdd, uint8_t regAdd, uint8_t *pBuffer, uint8_t size)
{
    ...
    status = HAL_I2C_Mem_Write( &hi2c3, chipAdd, regAdd, I2C_REG_ADD_SIZE_1_BYTE, pBuffer, size, I2C_TIMEOUT );
